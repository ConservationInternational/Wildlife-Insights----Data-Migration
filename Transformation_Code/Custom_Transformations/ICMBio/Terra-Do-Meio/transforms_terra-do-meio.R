...
dep <- read.csv("/Users/anthonyngo/Documents/Wildlife_Insights/ICMBio/Terra-Do-Meio/deployments.csv",1)
img <- read.csv("/Users/anthonyngo/Documents/Wildlife_Insights/ICMBio/Terra-Do-Meio/images.csv",1)
cam <- read.csv("/Users/anthonyngo/Documents/Wildlife_Insights/ICMBio/Terra-Do-Meio/cameras.csv",1)
prj <- read.csv("/Users/anthonyngo/Documents/Wildlife_Insights/ICMBio/Terra-Do-Meio/projects.csv",1)
...
linne_sloth=wi_taxonomy[wi_taxonomy$uniqueIdentifier=="bec186d5-350b-4eda-af3f-d9e3e9801df6","commonNameEnglish"]
img[img$wi_taxon_id == "bec186d5-350b-4eda-af3f-d9e3e9801df6", "common_name"] = linne_sloth
img$location <- paste(substr(img$location, 0, 26),substr(img$timestamp, 0, 4), substr(img$location, 26, 100), sep="")
...
write.table(dep,file="/Users/anthonyngo/Documents/Wildlife_Insights/ICMBio/Terra-Do-Meio/output/deployments.csv", row.names = FALSE, sep=",")
write.table(img,file="/Users/anthonyngo/Documents/Wildlife_Insights/ICMBio/Terra-Do-Meio/output/images.csv", row.names = FALSE, sep=",")
write.table(cam,file="/Users/anthonyngo/Documents/Wildlife_Insights/ICMBio/Terra-Do-Meio/output/cameras.csv", row.names = FALSE, sep=",")
write.table(prj,file="/Users/anthonyngo/Documents/Wildlife_Insights/ICMBio/Terra-Do-Meio/output/projects.csv", row.names = FALSE, sep=",")
