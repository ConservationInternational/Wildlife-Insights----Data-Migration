...
data16_path <- "/Users/anthonyngo/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/LSR_2016_ImageData.xlsx"
data17_path <- "/Users/anthonyngo/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/LSR_2017_ImageData.xlsx"
data18_path <- "/Users/anthonyngo/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/LSR_2018_ImageData.xlsx"

# Path of data in BU formatting
cam_path <- "/Users/anthonyngo/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/cameras.csv"
dep_path <- "/Users/anthonyngo/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/deployments.csv"
prj_path <- "/Users/anthonyngo/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/projects.csv"
...
img_raw$location <- paste("gs://cadfw/Deer_Program",
                          prj_id, paste("Camera_Trap_Images_", img_raw$year, sep=""),
...
# Adding Timestamps----
timestamps <- read.csv("~/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/LSR_exifs.csv")
...
write.table(cam_bu,file="/Users/anthonyngo/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/output/cameras.csv", row.names = FALSE, sep=",")
write.table(dep_bu,file="/Users/anthonyngo/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/output/deployments.csv", row.names = FALSE, sep=",")
write.table(img_bu,file="/Users/anthonyngo/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/output/images.csv", row.names = FALSE, sep=",")
write.table(prj_bu,file="/Users/anthonyngo/Documents/Wildlife_Insights/CDFW/deerimagefiles/LSR/output/projects.csv", row.names = FALSE, sep=",")
